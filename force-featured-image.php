	...
	public function admin_notices() {
		...
		switch ( $msg_id ) {
			case 'wrong-size' :
				...
				$msg = __( "This post's <strong>featured image doesn't match the required image dimensions</strong>. Please add an image with the following dimensions : ", 'force-featured-image' ) . $dimension;
				break;
			case 'no-image':
